 ...
 */
public class ABadgeAnimator extends ValueAnimator {
    private BitmapFragment[][] mFragments;
    private WeakReference<ABadgeView> mWeakBadge;

    public ABadgeAnimator(Bitmap badgeBitmap, PointF center, ABadgeView badge) {
        ...
        addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ABadgeView badgeView = mWeakBadge.get();
